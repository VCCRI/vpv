...
class Ui_Annotations(object):
    def setupUi(self, Annotations):
        ...
        self.treeViewAvailableTerms = QtGui.QTreeView(Annotations)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.treeViewAvailableTerms.sizePolicy().hasHeightForWidth())
        self.treeViewAvailableTerms.setSizePolicy(sizePolicy)
        self.treeViewAvailableTerms.setMinimumSize(QtCore.QSize(0, 300))
        self.treeViewAvailableTerms.setObjectName(_fromUtf8("treeViewAvailableTerms"))
        self.horizontalLayout_4.addWidget(self.treeViewAvailableTerms)
