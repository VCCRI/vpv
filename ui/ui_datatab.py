...
"color: rgb(223, 223, 223);"))
        ...
        self.pushButtonFilterQValue = QtGui.QPushButton(self.dataWidget)
        self.pushButtonFilterQValue.setObjectName(_fromUtf8("pushButtonFilterQValue"))
        self.horizontalLayout_10.addWidget(self.pushButtonFilterQValue)
        self.doubleSpinBoxQValue = QtGui.QDoubleSpinBox(self.dataWidget)
        self.doubleSpinBoxQValue.setObjectName(_fromUtf8("doubleSpinBoxQValue"))
        self.horizontalLayout_10.addWidget(self.doubleSpinBoxQValue)
