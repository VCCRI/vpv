...
class Ui_data(object):
    def setupUi(self, data):
        ...
        self.checkBoxFlipXY = QtWidgets.QCheckBox(data)
        self.checkBoxFlipXY.setObjectName("checkBoxFlipXY")
...
"color: rgb(223, 223, 223);")
    ...
    def retranslateUi(self, data):
        ...
        self.checkBoxInterpolate.setText(_translate("data", "Interpolate volumes"))
        ...
        self.checkBoxFlipXY.setText(_translate("data", "flip x/y"))
