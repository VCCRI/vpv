...
if __name__ == '__main__':
    wt_root = Path('/mnt/bit_nfs/neil/baselines/output/baseline')
    mut_root = Path('/mnt/bit_nfs/neil/mutants/output')
    wt_staging = Path('/mnt/bit_nfs/neil/baselines/output/staging_info_volume.csv')
    out_dir = Path('/mnt/bit_nfs/neil/mutants/qc/vpv_loaders')
