...
class Ui_Annotations(object):
    def setupUi(self, Annotations):
        ...
        self.pushButtonDiableRoi = QtWidgets.QPushButton(self.tab_3)
        self.pushButtonDiableRoi.setObjectName("pushButtonDiableRoi")
        self.horizontalLayout_20.addWidget(self.pushButtonDiableRoi)
    ...
    def retranslateUi(self, Annotations):
        ...
        self.pushButtonDiableRoi.setStatusTip(_translate("Annotations", "clar the annotation circle"))
